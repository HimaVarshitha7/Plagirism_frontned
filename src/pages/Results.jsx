      ...
      <Box component="main" sx={{ 
        ...
        <Container maxWidth="md">
          ...
          <Card sx={{ backgroundColor: "#0f172a", border: "1px solid #1e293b", borderRadius: 5, color: "white", mb: 4 }}>
            <CardContent sx={{ display: "flex", alignItems: "center", justifyContent: "space-around", flexWrap: "wrap", gap: 4, py: 5 }}>
              <Box sx={{ textAlign: 'center' }}>
                <Typography variant="subtitle2" sx={{ color: "#94a3b8", textTransform: "uppercase", letterSpacing: "0.1em" }}>Similarity Score</Typography>
                <Typography variant="h2" sx={{ color: "#60a5fa", fontWeight: "900", fontFamily: "'Poppins', sans-serif" }}>{plagiarismPercent}%</Typography>
              </Box>
              ...
              <Typography variant="body1" sx={{ fontWeight: 500, color: "#f8fafc", fontStyle: "italic", maxWidth: "250px", textAlign: "center" }}>"{feedback}"</Typography>
            </CardContent>
          </Card>
