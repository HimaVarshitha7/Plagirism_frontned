  ...
  return (
    <Box sx={{ 
      ...
      <Box component="main" sx={{ 
        flexGrow: 1, overflowY: "auto", py: 8,
              ...
              <Grid container spacing={5}>
                <Grid item xs={12} sm={7}>
                  ...
                  <TextField 
                    ...
                    value={userInfo.email} InputProps={{ readOnly: true }} 
                    sx={textFieldStyle} 
                  />
                </Grid>
                ...
                <Grid item xs={12} sm={5}>
                  ...
                  <Box sx={{ 
                    p: 4, bgcolor: "rgba(255,255,255,0.03)", borderRadius: 4, 
              ...
              <Box sx={{ mt: 6, display: 'flex', justifyContent: 'center', gap: 3 }}>
                {!isEditing ? (
                  <Button 
                    ...
                    sx={{ 
                      borderRadius: "50px", px: 6, py: 1.5, bgcolor: "#2563eb", 
                  ...
                  <>
                    <Button 
                      ...
                      onClick={handleSave} 
                      sx={{ 
                        borderRadius: "50px", px: 6, py: 1.5, bgcolor: "#10b981", 
                        fontWeight: "800", textTransform: "none", fontFamily: "'Poppins', sans-serif",
                    ...
                    <Button 
                      ...
                      sx={{ 
                        color: "#f87171", borderColor: "#f87171", borderRadius: "50px", px: 6, py: 1.5,
                        fontWeight: "800", textTransform: "none", fontFamily: "'Poppins', sans-serif",
