        ...
        <Container maxWidth="lg">
          ...
          <Grid container spacing={4}>
            <Grid item xs={12} md={4}>
              <StatCard title="Total Scans" value={stats.total} icon={<Analytics />} color="#3b82f6" subtitle="Lifetime document verifications" />
            </Grid>
            <Grid item xs={12} md={4}>
              <StatCard title="Plagiarism Detected" value={stats.plagiarized} icon={<BugReport />} color="#f87171" subtitle="Instances needing revision" />
            </Grid>
            <Grid item xs={12} md={4}>
              <StatCard title="Original Content" value={stats.original} icon={<AssignmentTurnedIn />} color="#60a5fa" subtitle="Validated unique documents" />
            </Grid>
          </Grid>
        </Container>
      </Box>
